//Change config.json for chapter number!
//
//
var sectionToComplete = 4; //change this for the section number 
//
//
//
...
async function selectzyBook(page) {
  ...
  await page.goto("https://learn.zybooks.com/zybook/" + 'NDCSE20311BualuanFall2022');
  ...
  for (const [idx, chapterItem] of chapters.entries()) {
    ...
    ] = `${chapterData["baseUrl"]}/chapter/${chapterNumber}/section/${sectionToComplete}`;
    //XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXCHANGE THIS LINE XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
  }
  return page;
}
